...
main (int argc, char *argv[])
{
  ...
  LogComponentEnable ("ThreeGppAntennaArrayModel",LOG_LEVEL_INFO);
...
// System Model in paper titled "On the Potential of Dynamic RF Channel Configuration for Energy Efficiency Optimization"
 ...
 //Config::SetDefault ("ns3::ThreeGppAntennaArrayModel::IsotropicElements", BooleanValue (true));
  ...
  Config::SetDefault ("ns3::ThreeGppAntennaArrayModel::AntennaHorizontalSpacing", DoubleValue (0.5)) ;
  Config::SetDefault ("ns3::ThreeGppAntennaArrayModel::AntennaVerticalSpacing", DoubleValue (0.5)) ;
  Config::SetDefault ("ns3::ThreeGppAntennaArrayModel::NumColumns", UintegerValue (4)); 
  Config::SetDefault ("ns3::ThreeGppAntennaArrayModel::NumRows", UintegerValue (4)); 
  Config::SetDefault ("ns3::ThreeGppAntennaArrayModel::ElementGain", DoubleValue (4.97)); 
  ...
  double isd_ue = 600; // (interside distance )
