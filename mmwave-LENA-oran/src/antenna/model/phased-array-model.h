...
class PhasedArrayModel : public Object
{
  public:
    ...
    /**
     * \brief Set electrical downtilt angle (degrees)
     */
    void SetRetAngle(double angleDeg);

    /**
     * \brief Get electrical downtilt angle (degrees)
     */
    double GetRetAngle() const;
  ...
  protected:
    ...
    double m_retAngleDeg {0.0}; //!< Electrical downtilt (degrees)
