        ...
        TypeId("ns3::SionnaMobilityModel")
            ...
            .AddAttribute("Model",
                          ...
                          MakeEnumChecker(SionnaMobilityModel::MODEL_CONSTANT_POSITION,
                                          ...
                                          "Random Walk",
                                          SionnaMobilityModel::MODEL_EXTERNAL,
                                          "External"))
            .AddAttribute("Mode",
...
{
    if (m_model == SionnaMobilityModel::MODEL_EXTERNAL)
    {
        return "External";
    }
    else if (m_model == SionnaMobilityModel::MODEL_RANDOM_WALK)
    {
        return "Random Walk";
    }
    else
...
bool
SionnaMobilityModel::IsExternal() const
{
    return m_model == SionnaMobilityModel::MODEL_EXTERNAL;
}

bool
SionnaMobilityModel::IsActive() const
{
    return m_active;
}

void
SionnaMobilityModel::SetActive(bool active)
{
    m_active = active;
}
